% shutorial(SECTION) | User Commands
%
% "August 27 2023"
...
shutorial - program to do something

# SYNOPSIS

**shutorial** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**shutorial** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **shutorial** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**shutorial** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    shutorial. See **foo.conf**(5) for further details.
...
**shutorial** provides some return codes, that can be used in scripts:
